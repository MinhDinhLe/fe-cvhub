  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      >
        <Breadcrumb>
          <Breadcrumb.Item>
            <Link to="/" style={{ color: '"rgb(0, 128, 0)"', fontWeight: '500' }}>
              Trang Chủ
            </Link>
          </Breadcrumb.Item>
        ...
        <h2 style={{ margin: '10px 0 0', fontWeight: 'bold' }}>
          Tuyển dụng <span style={{ color: 'rgb(0, 128, 0)' }}>{totalJobs}</span> việc làm mới nhất
          năm <span style={{ color: 'rgb(0, 128, 0)' }}>2024</span>
        </h2>
      </div>
